...
createServer({
    routes() {
        ...
        this.post("/all", (schema, request) => {
            const { count, lotName } = JSON.parse(request.requestBody)
            return all.filter(({name}, i) => name.toLowerCase().includes(lotName))
        }),
        ...
        this.get("/furniture", () => furniture),
        this.get("/furniture/:id", (schema, request) => {
            let reqId = request.params.id
            return {...furniture.find(({id}) => id === +reqId)}
        }),
        this.get("/electronics", () => electronics),
        this.get("/electronics/:id", (schema, request) => {
            let reqId = request.params.id
            return {...electronics.find(({id}) => id === +reqId)}
        }),
        this.get("/building", () => building),
        this.get("/building/:id", (schema, request) => {
            let reqId = request.params.id
            return {...building.find(({id}) => id === +reqId)}
        })
        this.get("/intangible", () => intangible),
        this.get("/intangible/:id", (schema, request) => {
            let reqId = request.params.id
            return {...intangible.find(({id}) => id === +reqId)}
        })
    },
})
...
const estate = [
    {   
        id: 1, category: 'estate', lot_number: 25084, initial_price: 937040.00, address: 'Лидский район, Дубровенский с/с, д. Огородники, ул. Новая, 1В', name: 'Здание гостиницы, д. Огородники', image: 'https://www.hardrockhotels.com/files/5829/SHRC_Hollywood_Guitar03.jpeg',
...
const furniture = [
    ...
    {   
        id: 17, category: 'furniture', lot_number: 25164, initial_price: 973945.56, address: 'Горецкий район, г. Горки, ул. Мира, 53', name: 'Недвижимое имущество с оборудованием (Завод железобетонных изделий)', image: 'https://rezult.pro/wp-content/themes/rezult/img/factory.jpg',
        deposit: 97394.55, description: 'Завод железобетонных изделий, инвентарный номер 720/C-19507, площадью 1994,4кв.м., расположенный по адресу: Могилевская область, Горецкий район, г. Горки, ул. Мира, 53, стоимость 369 300 рублей, без НДС. - Растворно-бетонный узел (РБУ)',
        request_start: '2022-06-20T09:00:54.578Z', request_end: '2022-07-07T17:00:54.578Z', auction_start: '2022-07-08T11:00:54.578Z', auction_end: ''
    },
    {   
        id: 18, category: 'furniture', lot_number: 25864, initial_price: 184700.00, address: 'г. Горки, ул. Мира, 53', name: 'Недвижимое имущество (эстакада с площадкой, здание сушилки, уборная, артезианская скважина, трансформаторная подстанция, бетонное покрытие, железобетонное ограждение)', image: 'https://xn--92-6kcaj2chwb1b5d.xn--p1ai/wp-content/uploads/2018/06/11_1.jpg',
        deposit: 18470.00, description: 'Победитель торгов возмещает стоимость затрат на проведение аукциона согласно прейскуранту (https://torgi.gov.by/assets/docs/priceList/preyskurant.docx) от фактической цены продажи лота, которая списывается с суммы внесенного Победителем аукциона задатка. Оставшаяся сумма задатка засчитывается в счет оплаты предмета аукциона. Также Покупатель обязуется оплатить возмещение затрат Продавца на организацию торгов. Затраты продавца на организацию и проведение электронных торгов составили: 1 089 рублей 58 копеек (1 083 рубля 87 копеек стоимость услуг по определению рыночной стоимости имущества, а так же 5 рублей 71 копейка стоимость публикаций в Едином государственном реестре сведений о банкротстве). Возмещение затрат по организации и проведению аукциона победитель осуществляет не позднее 5 рабочих дней с момента завершения торгов.',
        request_start: '2022-06-21T09:00:54.578Z', request_end: '2022-07-08T17:00:54.578Z', auction_start: '2022-07-09T11:00:54.578Z', auction_end: ''
    },
]
...
const electronics = [
    ...
    {   
        id: 20, category: 'electronics', lot_number: 25164, initial_price: 973945.56, address: 'Горецкий район, г. Горки, ул. Мира, 53', name: 'Недвижимое имущество с оборудованием (Завод железобетонных изделий)', image: 'https://rezult.pro/wp-content/themes/rezult/img/factory.jpg',
        deposit: 97394.55, description: 'Завод железобетонных изделий, инвентарный номер 720/C-19507, площадью 1994,4кв.м., расположенный по адресу: Могилевская область, Горецкий район, г. Горки, ул. Мира, 53, стоимость 369 300 рублей, без НДС. - Растворно-бетонный узел (РБУ)',
        request_start: '2022-06-20T09:00:54.578Z', request_end: '2022-07-07T17:00:54.578Z', auction_start: '2022-07-08T11:00:54.578Z', auction_end: ''
    },
    {   
        id: 21, category: 'electronics', lot_number: 25864, initial_price: 184700.00, address: 'г. Горки, ул. Мира, 53', name: 'Недвижимое имущество (эстакада с площадкой, здание сушилки, уборная, артезианская скважина, трансформаторная подстанция, бетонное покрытие, железобетонное ограждение)', image: 'https://xn--92-6kcaj2chwb1b5d.xn--p1ai/wp-content/uploads/2018/06/11_1.jpg',
        deposit: 18470.00, description: 'Победитель торгов возмещает стоимость затрат на проведение аукциона согласно прейскуранту (https://torgi.gov.by/assets/docs/priceList/preyskurant.docx) от фактической цены продажи лота, которая списывается с суммы внесенного Победителем аукциона задатка. Оставшаяся сумма задатка засчитывается в счет оплаты предмета аукциона. Также Покупатель обязуется оплатить возмещение затрат Продавца на организацию торгов. Затраты продавца на организацию и проведение электронных торгов составили: 1 089 рублей 58 копеек (1 083 рубля 87 копеек стоимость услуг по определению рыночной стоимости имущества, а так же 5 рублей 71 копейка стоимость публикаций в Едином государственном реестре сведений о банкротстве). Возмещение затрат по организации и проведению аукциона победитель осуществляет не позднее 5 рабочих дней с момента завершения торгов.',
        request_start: '2022-06-21T09:00:54.578Z', request_end: '2022-07-08T17:00:54.578Z', auction_start: '2022-07-09T11:00:54.578Z', auction_end: ''
    },
    {   
        id: 22, category: 'electronics', lot_number: 25164, initial_price: 973945.56, address: 'Горецкий район, г. Горки, ул. Мира, 53', name: 'Недвижимое имущество с оборудованием (Завод железобетонных изделий)', image: 'https://rezult.pro/wp-content/themes/rezult/img/factory.jpg',
        deposit: 97394.55, description: 'Завод железобетонных изделий, инвентарный номер 720/C-19507, площадью 1994,4кв.м., расположенный по адресу: Могилевская область, Горецкий район, г. Горки, ул. Мира, 53, стоимость 369 300 рублей, без НДС. - Растворно-бетонный узел (РБУ)',
        request_start: '2022-06-20T09:00:54.578Z', request_end: '2022-07-07T17:00:54.578Z', auction_start: '2022-07-08T11:00:54.578Z', auction_end: ''
    },
    {   
        id: 23, category: 'electronics', lot_number: 25864, initial_price: 184700.00, address: 'г. Горки, ул. Мира, 53', name: 'Недвижимое имущество (эстакада с площадкой, здание сушилки, уборная, артезианская скважина, трансформаторная подстанция, бетонное покрытие, железобетонное ограждение)', image: 'https://xn--92-6kcaj2chwb1b5d.xn--p1ai/wp-content/uploads/2018/06/11_1.jpg',
        deposit: 18470.00, description: 'Победитель торгов возмещает стоимость затрат на проведение аукциона согласно прейскуранту (https://torgi.gov.by/assets/docs/priceList/preyskurant.docx) от фактической цены продажи лота, которая списывается с суммы внесенного Победителем аукциона задатка. Оставшаяся сумма задатка засчитывается в счет оплаты предмета аукциона. Также Покупатель обязуется оплатить возмещение затрат Продавца на организацию торгов. Затраты продавца на организацию и проведение электронных торгов составили: 1 089 рублей 58 копеек (1 083 рубля 87 копеек стоимость услуг по определению рыночной стоимости имущества, а так же 5 рублей 71 копейка стоимость публикаций в Едином государственном реестре сведений о банкротстве). Возмещение затрат по организации и проведению аукциона победитель осуществляет не позднее 5 рабочих дней с момента завершения торгов.',
        request_start: '2022-06-21T09:00:54.578Z', request_end: '2022-07-08T17:00:54.578Z', auction_start: '2022-07-09T11:00:54.578Z', auction_end: ''
    },
]
...
const building = [
    ...
    {   
        id: 25, category: 'building', lot_number: 25164, initial_price: 973945.56, address: 'Горецкий район, г. Горки, ул. Мира, 53', name: 'Недвижимое имущество с оборудованием (Завод железобетонных изделий)', image: 'https://rezult.pro/wp-content/themes/rezult/img/factory.jpg',
        deposit: 97394.55, description: 'Завод железобетонных изделий, инвентарный номер 720/C-19507, площадью 1994,4кв.м., расположенный по адресу: Могилевская область, Горецкий район, г. Горки, ул. Мира, 53, стоимость 369 300 рублей, без НДС. - Растворно-бетонный узел (РБУ)',
        request_start: '2022-06-20T09:00:54.578Z', request_end: '2022-07-07T17:00:54.578Z', auction_start: '2022-07-08T11:00:54.578Z', auction_end: ''
    },
    {   
        id: 28, category: 'building', lot_number: 25864, initial_price: 184700.00, address: 'г. Горки, ул. Мира, 53', name: 'Недвижимое имущество (эстакада с площадкой, здание сушилки, уборная, артезианская скважина, трансформаторная подстанция, бетонное покрытие, железобетонное ограждение)', image: 'https://xn--92-6kcaj2chwb1b5d.xn--p1ai/wp-content/uploads/2018/06/11_1.jpg',
        deposit: 18470.00, description: 'Победитель торгов возмещает стоимость затрат на проведение аукциона согласно прейскуранту (https://torgi.gov.by/assets/docs/priceList/preyskurant.docx) от фактической цены продажи лота, которая списывается с суммы внесенного Победителем аукциона задатка. Оставшаяся сумма задатка засчитывается в счет оплаты предмета аукциона. Также Покупатель обязуется оплатить возмещение затрат Продавца на организацию торгов. Затраты продавца на организацию и проведение электронных торгов составили: 1 089 рублей 58 копеек (1 083 рубля 87 копеек стоимость услуг по определению рыночной стоимости имущества, а так же 5 рублей 71 копейка стоимость публикаций в Едином государственном реестре сведений о банкротстве). Возмещение затрат по организации и проведению аукциона победитель осуществляет не позднее 5 рабочих дней с момента завершения торгов.',
        request_start: '2022-06-21T09:00:54.578Z', request_end: '2022-07-08T17:00:54.578Z', auction_start: '2022-07-09T11:00:54.578Z', auction_end: ''
    },
    {   
        id: 26, category: 'building', lot_number: 25164, initial_price: 973945.56, address: 'Горецкий район, г. Горки, ул. Мира, 53', name: 'Недвижимое имущество с оборудованием (Завод железобетонных изделий)', image: 'https://rezult.pro/wp-content/themes/rezult/img/factory.jpg',
        deposit: 97394.55, description: 'Завод железобетонных изделий, инвентарный номер 720/C-19507, площадью 1994,4кв.м., расположенный по адресу: Могилевская область, Горецкий район, г. Горки, ул. Мира, 53, стоимость 369 300 рублей, без НДС. - Растворно-бетонный узел (РБУ)',
        request_start: '2022-06-20T09:00:54.578Z', request_end: '2022-07-07T17:00:54.578Z', auction_start: '2022-07-08T11:00:54.578Z', auction_end: ''
    },
    {   
        id: 27, category: 'building', lot_number: 25864, initial_price: 184700.00, address: 'г. Горки, ул. Мира, 53', name: 'Недвижимое имущество (эстакада с площадкой, здание сушилки, уборная, артезианская скважина, трансформаторная подстанция, бетонное покрытие, железобетонное ограждение)', image: 'https://xn--92-6kcaj2chwb1b5d.xn--p1ai/wp-content/uploads/2018/06/11_1.jpg',
        deposit: 18470.00, description: 'Победитель торгов возмещает стоимость затрат на проведение аукциона согласно прейскуранту (https://torgi.gov.by/assets/docs/priceList/preyskurant.docx) от фактической цены продажи лота, которая списывается с суммы внесенного Победителем аукциона задатка. Оставшаяся сумма задатка засчитывается в счет оплаты предмета аукциона. Также Покупатель обязуется оплатить возмещение затрат Продавца на организацию торгов. Затраты продавца на организацию и проведение электронных торгов составили: 1 089 рублей 58 копеек (1 083 рубля 87 копеек стоимость услуг по определению рыночной стоимости имущества, а так же 5 рублей 71 копейка стоимость публикаций в Едином государственном реестре сведений о банкротстве). Возмещение затрат по организации и проведению аукциона победитель осуществляет не позднее 5 рабочих дней с момента завершения торгов.',
        request_start: '2022-06-21T09:00:54.578Z', request_end: '2022-07-08T17:00:54.578Z', auction_start: '2022-07-09T11:00:54.578Z', auction_end: ''
    },
    {   
...
const intangible = [
    ...
    {   
        id: 31, category: 'intangible', lot_number: 25164, initial_price: 973945.56, address: 'Горецкий район, г. Горки, ул. Мира, 53', name: 'Недвижимое имущество с оборудованием (Завод железобетонных изделий)', image: 'https://rezult.pro/wp-content/themes/rezult/img/factory.jpg',
        deposit: 97394.55, description: 'Завод железобетонных изделий, инвентарный номер 720/C-19507, площадью 1994,4кв.м., расположенный по адресу: Могилевская область, Горецкий район, г. Горки, ул. Мира, 53, стоимость 369 300 рублей, без НДС. - Растворно-бетонный узел (РБУ)',
        request_start: '2022-06-20T09:00:54.578Z', request_end: '2022-07-07T17:00:54.578Z', auction_start: '2022-07-08T11:00:54.578Z', auction_end: ''
    },
]
...
const all = [...estate, ...transport, ...equipment, ...furniture, ...electronics, ...building, ...intangible]
